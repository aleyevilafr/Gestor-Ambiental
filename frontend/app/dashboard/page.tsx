...
import { getCurrentUser, getDashboardAttention, getDashboardSummary, getDashboardUpcoming, type AuthenticatedUser, type DashboardObligation, type DashboardSummary } from "@/lib/api";
...
export default function DashboardPage() {
  ...
  const [attention, setAttention] = useState<DashboardObligation[]>([]);
