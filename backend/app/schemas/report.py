...
class ReportSummary(BaseModel): total_obligations: int; active: int; compliant: int; in_progress: int; pending: int; overdue: int; due_soon: int; unassigned: int; compliance_percentage: float
